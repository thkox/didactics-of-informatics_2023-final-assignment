...
function checkResults() {
    ...
    if (document.getElementById('c3').style.backgroundColor == 'green') {
        ...
        result.innerHTML = `
            ...
            Ενώ η λειτουργία των <b>Συναρτήσεων</b><br>
            είναι πιο περιορισμένη, η <b>Διαδικασία</b> είναι <br>
            σαν μέρος λειτουργίας του κυρίως προγράμματος.<br>
            Στη Δραστηριότητα αυτή έγινε κλήση της <br>
            διαδικασίας με πέρασμα τιμών μέσω μιας λίστας<br>
            παραμέτρων, έγιναν υπολογισμοί και επέστρεψαν<br>
            νέες τιμές στις μεταβλητές <b>α</b>, <b>β</b>, <b>γ</b>. <br>
        `;
    }
}