...
function checkResults() {
    ...
    checkInputValue('b4', 'result', Number(b4.value) == 30 && document.getElementById('terminalb4').style.display == 'table-row', "Είσαι λίγο πριν το τέλος!<br>Προσπάθησε ξανά.<br> Έχει αλλάξει η τιμή του β στο κυρίως<br>πρόγραμμα");
